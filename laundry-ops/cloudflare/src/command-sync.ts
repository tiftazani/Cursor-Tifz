...
async function planGeneric(db:D1Database, command:SyncCommand, identity:SyncIdentity, token:string, now:number):Promise<Plan> {
  ...
  // sisi server tidak pernah menjadi penghalangnya; yang menolak adalah aplikasi. Pemeriksaan
  // di sini tetap dipertahankan sebagai penjaga, dan pesannya kini menyebut sebabnya.
