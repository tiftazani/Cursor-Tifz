...
VALUES
  ('tiftazani.khara@gmail.com', 'cuciin', 'Tiftazani', 'Owner', 1, 1, NULL, 1789610400000),
...
VALUES
  ...
  ('cuciin', 'staff', 'tiftazani.khara@gmail.com', 'upsert', '{"name":"Tiftazani","email":"tiftazani.khara@gmail.com","role":"Owner","branchIds":["debug-bunayya"],"approved":true,"active":true}', 1789610400000, 'debug-bunayya', 'system', 'debug-seed-owner-1-v1'),
