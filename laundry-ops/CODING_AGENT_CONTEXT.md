...
Server adalah sumber tarif komisi; harga nota boleh berubah tetapi `commissionPerUnit` tidak boleh dipercaya dari klien. Tutup kas append-only dan ID collision harus 409. Pending remote marker harus menyimpan generation agar acknowledgement yang cepat tidak mengembalikan shadow lama.
